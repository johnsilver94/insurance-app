...
public enum DriverCategory {
	...
	BE("Motor vehicles","Without prejudice to the provisions of type-approval rules for the vehicles concerned, a combination of vehicles consisting of a tractor vehicle in category B and a trailer or semi-trailer where the maximum authorised mass of the trailer or semi-trailer does not exceed 3,500 kilograms (7,700 lb)."),
